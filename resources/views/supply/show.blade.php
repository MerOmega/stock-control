<x-layout title="Insumo - {{ $supply->name }}">
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        <div class="mt-4">
            <p class="text-gray-700 dark:text-gray-300"><strong>Categoría:</strong> {{ $supply->category->name ?? 'N/A' }}</p>
            <p class="text-gray-700 dark:text-gray-300 mt-2"><strong>Cantidad:</strong> {{ $supply->quantity }}</p>
            <p class="text-gray-700 dark:text-gray-300 mt-2"><strong>Descripción:</strong> {{ $supply->description }}</p>
            <p class="text-gray-700 dark:text-gray-300 mt-2"><strong>Observaciones:</strong> {{ $supply->observations }}</p>
        </div>
