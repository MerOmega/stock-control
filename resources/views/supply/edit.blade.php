        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-2">
                        <select name="category_id" id="category_id" required
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}" {{ $supply->category_id == $category->id ? 'selected' : '' }}>
                                    {{ $category->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-span-full mt-6">
                    ...
                    <div class="mt-2">
                        <input type="number" name="quantity" id="quantity" value="{{ old('quantity', $supply->quantity) }}" required
                               class="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-600 dark:focus:ring-indigo-500 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="col-span-full mt-6">
                    ...
                    <div class="mt-2">
                        <textarea name="description" id="description"
                                  class="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-600 dark:focus:ring-indigo-500 sm:text-sm sm:leading-6">{{ old('description', $supply->description) }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-span-full mt-6">
                    ...
                    <div class="mt-2">
                        <textarea name="observations" id="observations"
                                  class="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-indigo-600 dark:focus:ring-indigo-500 sm:text-sm sm:leading-6">{{ old('observations', $supply->observations) }}</textarea>
                    </div>
                </div>

                {{-- Action Buttons --}}
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    <a href="{{ route('supplies.index') }}" class="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-100">Cancel</a>
                    <button type="submit"
