<x-layout title="Categoría">
    ...
    <div class="flex justify-between items-center mb-4">
        <form method="GET" action="{{ route('categories.index') }}" class="flex items-center space-x-2">
            ...
            <a href="{{ route('categories.index') }}" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                Reiniciar
            </a>
        </form>
...
{{--                <a href="{{ route('categories.show', $category->id) }}" class="flex-1 block p-6">--}}
                ...
                <div class="p-4 flex space-x-4">
                    ...
                    <a href="{{ route('categories.edit', $category->id) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-600">
