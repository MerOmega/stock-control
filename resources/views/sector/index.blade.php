<x-layout title="Sector">

    <div class="flex justify-between items-center mb-4">
        <form method="GET" action="{{ route('sectors.index') }}" class="flex items-center space-x-2">
            <input type="text" name="search" value="{{ request('search') }}" placeholder="Buscar sector..."
    ...
    <div class="space-y-6">
        @forelse($sectors as $sector)
            ...
            />
        @empty
            <p class="text-gray-500 dark:text-gray-400">No se encontraron sectores..</p>
        @endforelse
    </div>
