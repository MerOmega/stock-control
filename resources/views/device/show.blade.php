<x-layout title="Dispositivo - {{ $device->sku }}">
    ...
    <div id="device-container" data-device-id="{{ $device->id }}" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        <div class="mt-6">
            <h2 class="text-lg font-bold text-gray-900 dark:text-gray-100">Suministros por Categoría</h2>
            @foreach($suppliesByCategory as $categoryName => $supplies)
                <div class="mt-4">
                    ...
                    <table class="min-w-full bg-white dark:bg-gray-800 rounded-md shadow-md">
                        <thead>
                        <tr>
                            <th class="py-2 px-4 border-b border-gray-300 dark:border-gray-600 text-left text-gray-600 dark:text-gray-400">Suministro</th>
                        ...
                        @foreach($supplies as $supply)
                            <tr>
                                <td class="py-2 px-4 border-b border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300">{{ $supply->name }}</td>
        ...
        <div class="mt-6">
            ...
            <h2 class="text-lg font-bold text-gray-900 dark:text-gray-100">Agregar Suministros</h2>

            <div id="supply-fields" class="space-y-4">
                <div class="flex items-center space-x-2">
                    <input type="text" id="supply-search" placeholder="Buscar suministro..." class="block w-full rounded-md border-gray-300 dark:bg-gray-700 dark:text-gray-100" autocomplete="off">
